...
\begin{adcvtabletwo}
  ...
  \adcvrowskip
  \adcvrowmulti{Stepped into this role to help lead the company efforts to move application workloads into the cloud and off of our on-prem data centers. Worked on a team of people to develop the patterns, work on application infra libraries, documentation and met with every team at Priceline to train them on 12 factorization of their applications to the different systems that make up the new cloud platform. Beyond just moving application workloads to the cloud I was also heavily involved in how we move our data to the cloud so that it would be available local to our applications and dealing with keeping data replicated across many regions. In addition to the cloud infrastructure/application responsibilities I had across the company I was also working with my core Rental Car team on product/business initiatives}
