...
\begin{adcvtabletwo}
  ...
  \adcvrowskip
  \adcvrowmulti{Stepped into this role to help lead the companies efforts to move application workloads into the cloud and off of our on-prem data centers. The Rental Car team was selected to be the first team to experiment with running our applications in the cloud. This included all critical backend and frontend applications. Once patterns were established I worked with a small team training and helping the various teams at Priceline 12 factorize their applications and move their applications into GKE. This was being done while active project work was happening so I was also working hand in hand with my core Rental Car team to get them familiar with cloud technologies but also helping with Rental Car project work}
  ...
  \adcvrowmulti{When I first joined the Rental Car Services team I was very much heads down in building out new features, learning the rental car business and looking for opportunities to improve our systems and the business. We had a small but dynamic team and focused on projects that would have direct growth to our business. Some of the highlights during this time included adding new products like retail pre-paid rental cars, removing our legacy EJB infrastructure, improving our unit tests and CI tools and implementing a specialized DB caching resulting +25\% reduction in page load speeds. During this time the Rental Car team and my direct contributions were able to help the business achieve quarter after quarter growth of +20\%}
  \textbf{Relevant Technologies} REST, JSON, Java, Spring Framework, Tomcat, Oracle DB, MySql DB, Cassandra, Lucene, XML
  ...
  \adcvrowmulti{Designed and implemented Java enterprise components as Cigna used across the organization. Designed and implemented major parts of Cigna's first mobile applications including working directly on the mobile services platform which was a Python (Django) API to help transform legacy business API's into more modern REST + JSON. Also worked directly on and contributed to the myCigna Android application. I was one of the few engineers on the team that could work on the complete stack from the backend services API, Python middleware API and the Android application}
  \adcvrowskip
